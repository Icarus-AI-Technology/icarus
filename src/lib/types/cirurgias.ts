...
export const KANBAN_COLUMNS: KanbanColumn[] = [
  ...
  { id: 'aguardando_autorizacao', titulo: 'Aguardando Autorização', cor: '#F59E0B', icone: 'Clock', ordem: 3 },
  ...
  { id: 'aguardando_faturamento', titulo: 'Aguardando Faturamento', cor: '#F59E0B', icone: 'Receipt', ordem: 10 },
